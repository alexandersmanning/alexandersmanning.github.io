					...
					<content className="contact-link-container">
						...
						<div className="link-group">
							<a className="contact-link" href="https://github.com/alexandersmanning" target="_blank">
								<img className="contact-image" src="https://res.cloudinary.com/ddvdi1pie/image/upload/v1481004816/github-logo_avulo9.png"/>
							</a>
							<a className="contact-link" href="https://www.linkedin.com/in/alexandersmanning/" target="_blank">
								<img className="contact-image" src="https://res.cloudinary.com/ddvdi1pie/image/upload/v1481004820/linkedin-logo_ruddep.png"/>
							</a>
						</div>
					</content>
			</content>
